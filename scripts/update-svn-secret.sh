...
repos=("qiniu-kodo-wordpress" "aliyun-oss-wordpress" "sync-qcloud-cos" "realtimehot-weibo" "wp-baidu-textcensor" "textcensor-for-articles" "random-look" "MemorialDay" "upyun-uss-wordpress" "volcengine-imagex-wordpress" "huaweicloud-obs-wordpress" "pinyin-slug" "pangu.js" "sy-mailer")
owner="sy-records"
