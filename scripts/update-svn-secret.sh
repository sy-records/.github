...
repos=("qiniu-kodo-wordpress" "aliyun-oss-wordpress" "wordpress-qcloud-cos" "realtimehot-weibo" "wp-baidu-textcensor" "textcensor-for-articles" "random-look" "MemorialDay" "upyun-uss-wordpress" "volcengine-imagex-wordpress" "huaweicloud-obs-wordpress")
owner="sy-records"
